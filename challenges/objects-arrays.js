...
const Tyrannosaurus = new Dinosaur("tyrannosaurus","carnivorous",
"7000kg", "12m","Late Cretaceous");
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const Stegosaurus = new Dinosaur("stegosaurus","herbivorous",
"2000kg", "9m","Late Jurassic");
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const Velociraptor = new Dinosaur("velociraptor","carnivorous",
"15kg", "1.8m","Late Cretaceous");
...
console.log(Dinosaur.prototype.roar);
...
The zoos want to display both the scientific name and the animal 
name in front of the habitats. Populate the displayNames array with only the animal_name and scientific_name of each animal.
...
lowPopulationAnimals.push(zooAnimals.filter(zooAnimal => zooAnimal.population < 5));
...
const arrOfPopulations = [];
zooAnimals.map(zooAnimal => arrOfPopulations.push(`${zooAnimal.population}`));

populationTotal = arrOfPopulations.reduce( (acc,item) => acc + parseInt(item),0 );
